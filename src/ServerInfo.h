...
class ServerInfo {
public:
    ServerInfo(const QString& description, const QString& addr, const uint16_t port, const QString& path) noexcept;
    ...
    void set_port(const uint16_t port) noexcept { this->_port = port; }
