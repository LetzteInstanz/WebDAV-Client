...
SortParamItemModel::SortParamItemModel(std::shared_ptr<SettingsJsonFile> settings, std::shared_ptr<Qml::FileSortFilterItemModel> file_model, QObject* parent) : QAbstractListModel(parent), _settings(settings), _file_model(file_model) {}

SortParamItemModel::~SortParamItemModel() = default;
