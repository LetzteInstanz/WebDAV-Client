...
QString Parser::CurrentState::FSObjectStruct::extract_name(const QStringView& abs_path) {
    if (abs_path.empty())
        return QString();
...
Parser::CurrentState::FSObjectStruct::Status Parser::CurrentState::FSObjectStruct::to_status(const QStringView& str) {
...
void Parser::CurrentState::FSObjectStruct::replace_unknown_status(Status s) {
...
constexpr Parser::CurrentState::FSObjectStruct::Status Parser::CurrentState::FSObjectStruct::ret_second_if_first_is_unknown(Status first, Status second) {
    return first == FSObjectStruct::Status::Unknown ? second : first;
}

const std::vector<std::pair<QString, Parser::CurrentState::FSObjectStruct::Status>> Parser::CurrentState::FSObjectStruct::_str_code_pairs{
    {"200", Status::Ok},
