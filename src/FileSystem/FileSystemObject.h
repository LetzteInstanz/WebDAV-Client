...
public:
    ...
    std::optional<std::chrono::sys_seconds> get_creation_time() const noexcept;
    std::optional<std::chrono::sys_seconds> get_modification_time() const noexcept;
    std::optional<std::uint64_t> get_size() const noexcept;
