...
public:
    ...
    FileSystemObject(QString&& name, Type type, std::pair<Status, std::chrono::sys_seconds>&& creation_time, std::pair<Status, std::chrono::sys_seconds>&& modification_time, std::pair<Status, uint64_t>&& size) noexcept;
